...
if (welcomePrompt) {
    alert("hello hello hello");
        ...
        var sweet = prompt("How sweet do you want your drink? (0, 50, 100, 200)");

        if (parseInt(sweet) === 50) {
            alert("half sweetened");
        }

        else if (parseInt(sweet) === 100) {
            alert("normal sweet");
        }
        else if (parseInt(sweet) === 200) {
            alert("super sweet");
        }
        else {
            alert("no sweet added");
        }
        document.write("of your order of " + drinks + "boba with the sweet level of " + sweet + ".");
}
