...
textButton.setAttribute("class", "letter-button")
...
textButton.setAttribute(data-letter, letters[i]);
...
textDiv.class = this.data-letter;
...
document.querySelector("#display").append(textDiv);
  })
});
