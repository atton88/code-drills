...
document.onkeyup = function(event) {
  ...
  console.log(alphabet.includes(keyPress));
  if (alphabet.includes(keyPress)) {
    document.querySelector("#user-key").textContent = keyPress;
  

    letters.push(keyPress);
    document.querySelector("#user-history").textContent = letters.toString();
  }
}  
