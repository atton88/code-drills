...
for (j = 0; j < twoDimArray[0].length; j++) {
    if (twoDimArray[0][j] < 25) {
      console.log(twoDimArray[0][j]);
    }
}
...
for (j = 0; j < twoDimArray[1].length; j++) {
  if (twoDimArray[1][j] < 25) {
    console.log(twoDimArray[1][j]);
  }
}
...
for (j = 0; j < twoDimArray[2].length; j++) {
  if (twoDimArray[2][j] < 25) {
    console.log(twoDimArray[2][j]);
  }
}
...
for (j = 0; j < twoDimArray[3].length; j++) {
  if (twoDimArray[3][j] < 25) {
    console.log(twoDimArray[3][j]);
  }
}
...
for (j = 0; j < twoDimArray[4].length; j++) {
  if (twoDimArray[4][j] < 25) {
    console.log(twoDimArray[4][j]);
  }
}
